...
const Input = ({
  ...
  return (
    <div className={`w-1/2 ${className}`}>
      ...
      <input className={` bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${InputclassName}`}
